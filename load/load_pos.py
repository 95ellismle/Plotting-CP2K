...
# Reads 1 frc file
def load_pos(filepath, min_time=0, max_time='all', stride=1, ignore_steps=[]):
    """
    Load forces
    """
...
def load_all_vel_in_folder(folder, min_time=0, max_time='all', stride=1, ignore_steps=[], reps='all'):
    """
...
# Reads all the Qlk files from a given folder
def load_all_pos_in_folder(folder, min_time=0, max_time='all', stride=1, ignore_steps=[], reps='all'):
    """
    Loads all forces in a folder
    """
    return Utils.load_all_in_folder(folder=folder,
